...
- SLSA 1.2 framework: Source and Build tracks for supply chain security
- Tekton Chains observer pattern for Build L3 provenance
- Source track attestations with slsa-framework/source-tool
- Trusted tasks and trusted artifacts for pipeline integrity
